                ...
                <div className="profileContactForm" id="contato">
                    ...
                    <form onSubmit={handleSubmit} className="contactForm">
                        ...
                        <div className="formGroup">
                            ...
                            <textarea id="message" name="message" placeholder="Conte-me sobre seu projeto ou ideia..." rows={4} required></textarea>
                        </div>

                        <button
                            type="submit"
                            className={`contactSubmitBtn ${isSubmitting ? "submitting" : ""} ${submitStatus === "success" ? "success" : ""} ${
