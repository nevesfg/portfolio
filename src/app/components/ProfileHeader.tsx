...
export default function ProfileHeader() {
    ...
    return (
        <>
                            ...
                            <div className="profileHeaderCenteredCol">
                                <div className="profileHeaderTopRow">
                                    ...
                                    <div className="profileHeaderActions">
                                        ...
                                        >
                                            <svg className="cvIcon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            {isModalOpen && (
                <div className={`contactModalOverlay${isClosing ? ' closing' : ''}`} onClick={closeModal}>
                    <div className={`contactModalBox${isClosing ? ' closing' : ''}`} onClick={e => e.stopPropagation()}>
                        <button className="contactModalClose" onClick={closeModal}>✕</button>

                        <div className="profileContactForm">
                            ...
                            <form onSubmit={handleSubmit} className="contactForm">
                                <div className="formGroup">
                                    ...
                                    <input type="text" id="modal-name" name="name" placeholder="Seu nome completo" required />
                                </div>
                                <div className="formGroup">
                                    <label htmlFor="modal-email">Email</label>
                                    <input type="email" id="modal-email" name="email" placeholder="seu@email.com" required />
                                </div>
                                <div className="formGroup">
                                    <label htmlFor="modal-message">Mensagem</label>
                                    <textarea id="modal-message" name="message" placeholder="Conte-me sobre seu projeto ou ideia..." rows={4} required></textarea>
                                </div>
                                ...
                                >
                                    {isSubmitting ? (
                                        <><span>Enviando...</span><div className="spinner"></div></>
                                    ) : submitStatus === 'success' ? (
                                        <><span>Enviado!</span><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg></>
                                    ) : submitStatus === 'error' ? (
                                        <><span>Erro - Tente novamente</span><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg></>
                                    ) : (
                                        <><span>Enviar Mensagem</span><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></>
                                    )}
                                </button>
                            </form>
                        </div>
