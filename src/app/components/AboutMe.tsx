                        ...
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    Me chamo Victor, desenvolvedor Front-End e estou no último semestre de Análise e Desenvolvimento de Sistemas no IF Baiano - Campus Guanambi.
                                    Transformei minha paixão por tecnologia em carreira após mais de três anos de estudos acadêmicos e, antes disso, estudei programação como hobby.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="aboutMeSection">
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    Tenho habilidades backend com Node.js, Git, PostgreSQL, MySQL, Django Rest Framework e Java. 
                                    No frontend, trabalho com as seguintes tecnologias:
                                </div>
                        ...
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    ...
                                    Entusiasta de games, que contribuem para minha criatividade e pensamento inovador, 
                                    estou sempre atento às tendências que impulsionam a evolução da tecnologia.
                                </div>
                            </div>
                        </div>
                    </div>
