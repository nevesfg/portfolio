export default function AboutMe() {
    return (
        <div className="profileCustomization">
            <div className="profileRecentgameHeader">Sobre Mim</div>
                        ...
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    Sou Desenvolvedor Front-End, graduado em Análise e Desenvolvimento de Sistemas pelo IF Baiano – Campus Guanambi.
                                    <br />
                                    <br />
                                    Minha jornada na tecnologia começou como hobby e, ao longo de anos de estudo acadêmico e prática, evoluiu para se
                                    tornar tanto uma carreira quanto uma missão pessoal. Ao longo desse caminho, desenvolvi uma compreensão sólida
                                    sobre como criar aplicações web eficientes, intuitivas e visualmente atraentes.
                                </div>
                                <blockquote className="github-quote">"Se você pode sonhar, você pode realizar." — Walt Disney</blockquote>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="aboutMeSection">
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    Embora meu foco atual seja o Front-End, também construí uma base consistente no backend, o que me permite atuar
                                    com visão completa do produto.
                                    <br />
                                    <br />
                    ...
                    <div className="aboutMeSection">
                        <div className="aboutMeItem">
                            ...
                            <div className="aboutMeDetails">
                                ...
                                <div className="aboutMeDescription">
                                    Além da área técnica, sou um entusiasta do universo dos games, algo que impulsiona minha criatividade, minha visão
                                    estética e até meu inglês características que agregam valor ao meu processo de desenvolvimento e à forma como
                                    penso soluções.
                                </div>
                                <div className="aboutMeDescription">
