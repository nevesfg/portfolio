...
export default function AllComments() {
    ...
    const handleSubmitComment = async (e: React.FormEvent) => {
        ...
        // Validar se tem conteúdo e está autenticado (LinkedIn ou anônimo com Pokémon)
        ...
        try {
            ...
            if (response.ok) {
                ...
                setNewComment('');
                setCurrentPage(1); // Voltar para a primeira página para ver o novo comentário
                
                // Iniciar cooldown para usuários anônimos
                if (authMode === 'anonymous') {
                    setCooldownSeconds(60);
                    generateNewPokemon();
                }
                
                // Mostrar aviso se comentário foi marcado para revisão
                ...
                if (response.status === 429) {
                    // Rate limit - extrair segundos da mensagem
    ...
    if (loading) {
        return (
            <div className="profileCustomization">
                <div className="profileCustomizationHeader">Todos os Comentários</div>
                ...
                <div className="commentthreadArea">
                    <div className="commentthreadHeader">
                        <div className="commentthreadHeaderAndCount">
                            <span className="commentthreadCountLabel">
                                {totalComments} comentários encontrados
                            </span>
                    ...
                    <div className="allCommentsFooter">
                        <button 
